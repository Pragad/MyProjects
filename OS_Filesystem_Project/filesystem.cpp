...
// void updateParentBlock(uint32_t parentBlockNum, uint32_t availableIndex, uint32_t childBlockNum, uint8_t  fileDirType, const char* strFileDirName)
//
...
// void createFilePreProcess(string strFileName)
// void createFileOrDirectory(string strType, string strFileName)
//
// void parseInputCommand(string inputCmd)
// void getInputCommand()
//
// int traversePathFindCurrAndParentBlkNum(string strFileName, int& tempBlockNumber, int& parentBlockNumber)
// void createDirectoryEntrySupplements(int currBlockNumber, string currBlockName, int parentBlockNumber, string parentBlockName)
//-------------------------------------------------------------------------------------------------
...
{
    cout << "***TRACKING STRUCT***" << endl;
    cout << "Pbn: " << readStruct.parentBlockNumber << "; Cbn: " << \
...
void write(int blockno, int noOfBytes, int readPointer, const char* input, int startIndex)
{
    ...
    cout << "ACTUAL WRITE: rdPtr: " << readPointer << "; sIdx: " << startIndex << "; tot: " << totSize << "; blNo. : " << blockno << endl;
...
void createFileParentDirEntry (int blockNum, int freeIndex, int fBlockNum)
{
   myDisk.blocks[blockNum].blockDir.dirEntries[freeIndex].dirType = 'F'; 
   std::string tmpStr ("NULL");
   tmpStr.copy((char *)myDisk.blocks[blockNum].blockDir.dirEntries[freeIndex].fileName, 9);
   myDisk.blocks[blockNum].blockDir.dirEntries[freeIndex].lastBlockUsedBytes = -1;
...
void deleteDirPreProcess(int curBlockNum, int parentBlockNum)
{
    ...
    {
        cout << "ANUP: Invalid Block Numbers" << endl;
        return;
    }
}
...
void parseInputCommand(string inputCmd)
{
    ...
    */
    ...
    {
        cout << "1. Create a file or directory: " << endl;
    ...
    {
        cout << "7. Delete a file or directory: " << endl;
...
int main()
{
    ...
    */
    ...
    do
    {
        ...
        cout << "1. If you want to enter the commant, type 1"<<endl;
