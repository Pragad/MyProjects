...
public class AccelerometerManager {
    ...
    private static float threshold     = 2.2f;         //0.2f;
    private static long interval     = 1000000;
   ...
   static Sensor magnetometer;
    ...
    private static SensorEventListener sensorEventListener = 
        ...
        //BigInteger timediffvalue = new BigInteger(1000000000000);
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (lastUpdate == 0) {
                ...
                if (timeDiff > 1000000000000000000L) {
            ...
            listener.onAccelerationChanged(x, y, z,event);
