/* Corner Detection using Harris/Plessey coner detector algorithm. Parallelized using omp constructs */
...
int main(int argc, char* argv[])
{
	...
	*/
	...
	#pragma omp parallel for private(i, j, Ih, Iv)
	...
	#pragma omp parallel for private(i, j, A, B, C, det_M, trace_M)
	...
	bmp_save(bmp_op, "bmp_corner_par.bmp");
